...
/**
   ...
   JavaBeans {@link java.beans.Introspector} to analyze the given Object Class using
   reflection.
   ...
   Otherwise an {@link java.beans.IntrospectionException} are thrown.
...
public class PropertySetter {
  ...
  /**
     Uses JavaBeans {@link java.beans.Introspector} to computer setters of object to be
     configured.
   */
  protected
  void introspect() {
  ...
  */
  ...
  /** 
      Set the named property given a {@link java.beans.PropertyDescriptor}.
