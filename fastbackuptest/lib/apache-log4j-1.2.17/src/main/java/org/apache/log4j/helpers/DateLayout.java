...
abstract public class DateLayout extends Layout {
  ...
  */
  ...
  /**
    ...
    argument to the constructor of {@link java.text.SimpleDateFormat} or one of
  ...
  /**
    ...
    expected by the {@link java.util.TimeZone#getTimeZone} method.
   */
  public
  ...
  /**
     Sets the {@link java.text.DateFormat} used to format time and date in the
  ...
  /**
     ...
     determined by <code>timeZone</code> parameter. The {@link java.text.DateFormat} used
